...
public class TrackResponseDto {
	...
	public String toString() {
		return "TrackResponseDto [registrationId=" + registrationId + ", username=" + username + ", name=" + name
				+ ", email=" + email + ", mobNumber=" + mobNumber + ", gender=" + gender + ", dob=" + dob + ", status="
				+ status + ", createdAt=" + createdAt + ", updatedAt=" + updatedAt + ", govIdFront=" + govIdFront
				+ ", govIdBack=" + govIdBack + ", photo=" + photo + ", processingStatus=" + processingStatus
				+ ", remark=" + remark + "]";
	}
